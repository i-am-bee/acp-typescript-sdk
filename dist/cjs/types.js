...
const BaseRequestParamsSchema = zod_1.z
    ...
    _meta: zod_1.z.optional(zod_1.z
         ...
         */
        traceparent: zod_1.z.optional(zod_1.z.string()),
        tracestate: zod_1.z.optional(zod_1.z.string()),
    })
        .passthrough()),
})
    .passthrough();
 ...
 */
exports.AgentTemplateSchema = zod_1.z
    .object({
    /**
 ...
 */
exports.ListAgentTemplatesRequestSchema = exports.PaginatedRequestSchema.extend({
    method: zod_1.z.literal("agents/templates/list"),
});
/**
 ...
 * Used by the client to run an agent provided by the server.
 */
exports.RunAgentRequestSchema = exports.RequestSchema.extend({
 ...
 */
exports.AgentListChangedNotificationSchema = exports.NotificationSchema.extend({
    method: zod_1.z.literal("notifications/agents/list_changed"),
});
/* Client messages */

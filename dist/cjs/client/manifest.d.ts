...
declare const transport: z.ZodUnion<[z.ZodObject<{
...
export declare function createClientTransport(transport: Transport): SSEClientTransport | StdioClientTransport;
export {};
